...
/**
 * The configuration screen for the {@link TodayWidget TodayWidget} AppWidget.
 */
public class TodayWidgetConfigureActivity extends Activity {

    private static final String PREFS_NAME = "com.example.android.sunshine.app.widget.TodayWidget";
